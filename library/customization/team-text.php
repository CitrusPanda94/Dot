...
$wp_customize->add_setting('massage_team_message_blurb', array(
   'capability' => 'edit_theme_options',
   'default' => __('Write content here!!')
));

$wp_customize->add_control('massage_team_message_blurb_control', array(
   'type' => 'textarea',
   'section' => 'massage_page',
   'settings' => 'massage_team_message_blurb',
   'label' => __('Team')
));
